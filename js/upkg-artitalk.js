        ...
        ([function (e, t, n) {
                    (function (e, n) {
                        ...
                        !function () {
                            ...
                            void 0 === t || t.nodeType ? i._ = _ : (void 0 !== n && !n.nodeType && n.exports && (t = n.exports = _), t._ = _),
                            _.VERSION = "1.9.1";
                            var v,
                            y = function (e, t, n) {
                                if (void 0 === t)
                            ...
                            _.max = function (e, t, n) {
                                ...
                                if (null == t || "number" == typeof t && "object" != typeof e[0] && null != e)
                                    ...
                                    t = b(t, n), _.each(e, (function (e, n, r) {
                            ...
                            _.memoize = function (e, t) {
                                var n = function (r) {
                                    ...
                                    return A(i, a) || (i[a] = e.apply(this, arguments)),
                                    i[a]
                                };
                                return n.cache = {},
                                n
                            ...
                            _.throttle = function (e, t, n) {
                                ...
                                l = function () {
                                    ...
                                    return i = this,
                                    a = arguments,
                                    c <= 0 || c > t ? (r && (clearTimeout(r), r = null), s = l, o = e.apply(i, a), r || (i = a = null)) : r || !1 === n.trailing || (r = setTimeout(u, c)),
                                    o
                                };
                            ...
                            U = function (e, t) {
                                ...
                                for (A(e, a) && !_.contains(t, a) && t.push(a); n--; )
                                    (a = N[n])in e && e[a] !== i[a] && !_.contains(t, a) && t.push(a)
                            };
                            _.keys = function (e) {
                                if (!_.isObject(e))
                                    return [];
                            ...
                            D = function (e, t, n, r) {
                                ...
                                if (!a) {
                                    ...
                                    var o = e.constructor,
                                    s = t.constructor;
                                    if (o !== s && !(_.isFunction(o) && o instanceof o && _.isFunction(s) && s instanceof s) && "constructor" in e && "constructor" in t)
                                        return !1
                                }
                                r = r || [];
                                ...
                                if (n.push(e), r.push(t), a) {
                                    ...
                                    var c,
                                    d = _.keys(e);
                                    if (l = d.length, _.keys(t).length !== l)
                                        return !1;
                                    for (; l--; )
                                        if (c = d[l], !A(t, c) || !R(e[c], t[c], n, r))
                                            return !1
                                }
                                return n.pop(),
                                r.pop(),
                            ...
                            _.template = function (e, t, n) {
                                ...
                                e.replace(i, (function (t, n, r, i, s) {
                                        return o += e.slice(a, s).replace(J, X),
                                        a = s + t.length,
                        ...
                        ajax: function (e) {
                            ...
                            var b = f("request")(n, {
                                ...
                                onprogress: _
                                        ...
                                        throw e.response && (h.enabled("leancloud:request") || p("request(%d) %s %s %o %o %o", y, t, n, r, i, l), p("response(%d) %d %O %o", y, e.response.status, e.response.data || e.response.text, e.response.header), e.statusCode = e.response.status, e.responseText = e.response.text, e.response = e.response.data),
                                        e
                                    }));
                            return g ? c(b, g) : b
                        },
                    ...
                    p = function () {
                        ...
                        i ? s.masterKey ? t ? n["X-LC-Sign"] = h(s.masterKey, !0) : n["X-LC-Key"] = s.masterKey + ",master" : (console.warn("masterKey is not set, fall back to use appKey"), d(n, t)) : d(n, t),
                        ...
                        return p(l, d).then((function (e) {
                                return c({
                                    ...
                                    timeout: f
                                        ...
                                        s._sharedConfig.keepErrorRawMessage || (t.error += " [" + (e.statusCode || "N/A") + " " + r + " " + m + "]");
                    ...
                    u = function (e, t, n) {
                        ...
                        for (l in p && (n = t), n)
                            (c = !d && b && void 0 !== b[l]) && s(v, l) || (h = c ? b[l] : n[l], v[l] = p && "function" != typeof b[l] ? n[l] : g && c ? a(h, r) : _ && b[l] == h ? function (e) {
                    ...
                    (function (t) {
                        ...
                        m._getInstallationId = function () {
                            ...
                            return m.localStorage.getItemAsync(e).then((function (t) {
                                    return m._installationId = t,
                                    m._installationId ? t : (m._installationId = t = u(), m.localStorage.setItemAsync(e, t).then((function () {
                                                return t
                                            })))
                                }))
                        },
                        ...
                        m._encode = function (e, t, n) {
                            ...
                            if (s.isRegExp(e))
                                return e.source;
                            if (e instanceof m.Relation)
                                return e.toJSON();
                            if (e instanceof m.Op)
                                return e.toJSON();
                        ...
                        m._decode = function (e, t) {
                            ...
                            if ("Relation" === e.__type) {
                                ...
                                return l.targetClassName = e.className,
                                l
                            }
                            if ("File" === e.__type) {
                                var c = new m.File(e.name),
                                h = s.clone(e);
                                return delete h.__type,
                                c._finishFetch(h),
                                c
                            }
                        ...
                        m._traverse = function (e, t, n) {
                            if (e instanceof m.Object) {
                                if (n = n || [], s.indexOf(n, e) >= 0)
                                    return;
                                return n.push(e),
                                m._traverse(e.attributes, t, n),
                                t(e)
                            }
                    ...
                    u = function () {
                        ...
                        t = n(38)("iframe"),
                        r = a.length;
                        for (t.style.display = "none", n(57).appendChild(t), t.src = "javascript:", (e = t.contentWindow.document).open(), e.write("<script>document.F=Object<\/script>"), e.close(), u = e.F; r--; )
                    ...
                    M = function (e) {
                        _.call(u, (function () {
                                ...
                                if (a && (t = b((function () {
                                                ...
                                                })), e._h = O || q(e) ? 2 : 1), e._a = void 0, a && t.e)
                                    throw t.v
                            }))
                    },
                    q = function (e) {
            ...
            e.exports = function (e, t, n, r) {
                ...
                G = function (e, t, n) {
                    ...
                    t = k(t, !0),
                    v(n),
                    i(R, t) ? (n.enumerable ? (i(e, L) && e[L][t] && (e[L][t] = !1), n = A(n, {
                                enumerable: j(0, !1)
                ...
                Z = function (e, t) {
                    if (e = w(e), t = k(t, !0), e !== F || !i(R, t) || i(D, t)) {
                        var n = T(e, t);
                        return !n || !i(R, t) || i(e, L) && e[L][t] || (n.enumerable = !0),
                        n
                    }
                },
                Y = function (e) {
                ...
                ee = function (e) {
                    for (var t, n = e === F, r = P(n ? D : w(e)), a = [], o = 0; r.length > o; )
                ...
                a.init = function (e) {
                    ...
                    y = e.production,
                    b = e.realtime;
                    if (m && console.warn("Initializing LeanCloud Storage SDK which has already been initialized. Reinitializing the SDK might cause problems like unexpected cross-app data writing and invalid relations."), !t)
                        throw new TypeError("appId must be a string");
                    if (!n)
                        throw new TypeError("appKey must be a string");
                    if (i && console.warn("MasterKey is not supposed to be used at client side."), d(t) && !_ && h(a._config.serverURLs))
                        throw new TypeError("serverURL option is required for apps from CN region");
                    t !== a._config.applicationId ? (a._config.masterKey = i, a._config.hookKey = s) : (i && (a._config.masterKey = i), s && (a._config.hookKey = s)),
                    a._config.applicationId = t,
                    a._config.applicationKey = n,
                    a.setProduction(y),
                    void 0 !== v && (a._config.disableCurrentUser = v);
                    var w = f || void 0 !== _;
                    if (w || (a._appRouter = new o(a)), a._setServerURLs(l({}, r(t), a._config.serverURLs, "string" == typeof _ ? p(_) : _), w), b)
                ...
                a._setServerURLs = function (e) {
                    ...
                    "string" != typeof e ? l(a._config.serverURLs, e) : a._config.serverURLs = p(e),
                ...
                e.exports = function (e) {
                    ...
                    e.Events = {
                        on: function (e, n, r) {
                            ...
                            if (!n)
                                return this;
                            for (e = e.split(t), i = this._callbacks || (this._callbacks = {}), a = e.shift(); a; )
                                ...
                                for (a = (e = e ? e.split(t) : r.keys(o)).shift(); a; )
                                    if (s = o[a], delete o[a], s && (n || i)) {
                                        for (u = s.tail, s = s.next; s !== u; )
                                            l = s.callback, c = s.context, (n && l !== n || i && c !== i) && this.on(a, l, c), s = s.next;
                                        a = e.shift()
                                    }
                                return this
                            }
                ...
                e.exports = function (e) {
                    ...
                    e.ACL.prototype._setAccess = function (t, n, i) {
                        if (n instanceof e.User ? n = n.id : n instanceof e.Role && (n = "role:" + n.getName()), !r.isString(n))
                        ...
                        _mergeWithPrevious: function (t) {
                            if (t) {
                                ...
                                if (t instanceof e.Op.Relation) {
                                    ...
                                    return a._targetClassName = this._targetClassName,
                                    a
                                }
                                throw new Error("Op is invalid after previous op.")
                            }
                ...
                e.exports = function (e) {
                    ...
                    r.extend(e.Relation.prototype, {
                        ...
                        query: function () {
                            var t,
                            n;
                            return this.targetClassName ? (t = e.Object._getSubclass(this.targetClassName), n = new e.Query(t)) : (t = e.Object._getSubclass(this.parent.className), (n = new e.Query(t))._defaultParams.redirectClassNameForKey = this.key),
                ...
                e.exports = function (e) {
                    ...
                    i.extend(e.File.prototype, {
                        ...
                        _fileToken: function (e, r) {
                            ...
                            l("fileTokens", null, null, "POST", s, r)
                        },
                        save: function () {
                            var e = this,
                            ...
                            if (!this._previousSave)
                                if (this._data) {
                                    ...
                                    this._previousSave = this._fileToken(n, t).then((function (u) {
                                                return u.mime_type && (n = u.mime_type, e.set("mime_type", n)),
                                                e._token = u.token,
                                                r.default.resolve().then((function () {
                                                        var t = e._data;
                                                        if (t && t.base64)
                                                            return f(t.base64, n);
                                                        if (t && t.blob)
                                                            return !t.blob.type && n && (t.blob.type = n), t.blob.name || (t.blob.name = e.get("name")), t.blob;
                ...
                e.exports = function (e, t, n) {
                    ...
                    return i("url: %s, file: %o, options: %o", o, s, u),
                    r("upload")(o, s, u).then((function (e) {
                            ...
                            var t = e.response;
                            throw t && (i(t.status, t.data), e.statusCode = t.status, e.response = t.data),
                            e
                        }))
                }
            }, function (e, t, n) {
                ...
                e.exports = function (e, t, n) {
                    ...
                    return a("url: %s, file: %o, options: %o", u, l, c),
                    i("upload")(u, l, c).then((function (e) {
                            ...
                            var t = e.response;
                            throw t && (a(t.status, t.data), e.statusCode = t.status, e.response = t.data),
                            e
                        }))
                }
            }, function (e, t, n) {
                ...
                !function () {
                    ...
                    o = function (e, n) {
                        ...
                        for (var s = t.bytesToWords(e), u = 8 * e.length, l = 1732584193, c = -271733879, h = -1732584194, d = 271733878, p = 0; p < s.length; p++)
                        ...
                        for (p = 0; p < s.length; p += 16) {
                            ...
                            l = m(l, c = f(c, h, d, l, s[p + 15], 22, 1236535329), h, d, s[p + 1], 5, -165796510),
                            ...
                            l = g(l, c = m(c, h, d, l, s[p + 12], 20, -1926607734), h, d, s[p + 5], 4, -378558),
                            ...
                            l = _(l, c = g(c, h, d, l, s[p + 2], 23, -995338651), h, d, s[p + 0], 6, -198630844),
                ...
                e.exports = function (e) {
                    ...
                    l.extend(e.Object.prototype, e.Events, {
                        ...
                        fetchWhenSave: function (e) {
                            if (console.warn("AV.Object#fetchWhenSave is deprecated, use AV.Object#save with options.fetchWhenSave instead."), !l.isBoolean(e))
                        ...
                        _toFullJSON: function (t) {
                            ...
                            r && (i.__type = "Object", l.isArray(t) && t.length && (i.__type = "Pointer"), i.className = this.className),
                            i
                        },
                        ...
                        escape: function (e) {
                            ...
                            var n,
                            r = this.attributes[e];
                            return n = p(r) ? "" : l.escape(r.toString()),
                        ...
                        set: function (t, n, r) {
                            ...
                            if (l.isObject(t) || p(t) ? (i = l.mapObject(t, (function (t, n) {
                                                return k(n),
                                                e._decode(t, n)
                                            })), r = n) : (i = {}, k(t), i[t] = e._decode(n, t)), r = r || {}, !i)
                                return this;
                            ...
                            return e._arrayEach(l.keys(i), (function (t) {
                                    ...
                                    var a = !0;
                                    n instanceof e.Op.Set && l.isEqual(o.attributes[t], n.value) && (a = !1),
                                    a && (delete s[t], r.silent ? o._silent[t] = !0 : r.changes[t] = !0);
                                    var u = l.last(o._opSetQueue);
                                    u[t] = n._mergeWithPrevious(u[t]),
                                    o._rebuildEstimatedDataForKey(t),
                                    a ? (o.changed[t] = o.attributes[t], r.silent || (o._pending[t] = !0)) : (delete o.changed[t], delete o._pending[t])
                                })),
                        ...
                        increment: function (t, n) {
                            return (l.isUndefined(n) || l.isNull(n)) && (n = 1),
                        ...
                        save: function (t, n, r) {
                            ...
                            a,
                            o;
                            l.isObject(t) || p(t) ? (i = t, o = n) : ((i = {})[t] = n, o = r),
                            ...
                            d = [],
                            f = [];
                            return e.Object._findUnsavedChildren(c, d, f),
                            d.length + f.length > 1 ? e.Object._deepSaveAsync(this, c, o) : (this._startSave(), this._saving = (this._saving || 0) + 1, this._allPreviousSaves = this._allPreviousSaves || u.default.resolve(), this._allPreviousSaves = this._allPreviousSaves.catch((function (e) {})).then((function () {
                                            var e,
                                            t = c.id ? "PUT" : "POST",
                                            n = c._getSaveJSON(),
                                            r = {};
                                            if (((c._fetchWhenSave || o.fetchWhenSave) && (r.new = "true"), o._failOnNotExist && (r.failOnNotExist = "true"), o.query) && ("function" == typeof o.query._getParams && (e = o.query._getParams()) && (r.where = e.where), !r.where))
                        ...
                        ignoreHook: function (t) {
                            if (!l.contains(["beforeSave", "afterSave", "beforeUpdate", "afterUpdate", "beforeDelete", "afterDelete"], t))
                    ...
                    e.Object.destroyAll = function (e) {
                        ...
                        return h("batch", null, null, "POST", r, t).then((function (e) {
                                ...
                                if (t)
                                    throw new c(t.error.code, t.error.error)
                            }))
                    },
                    ...
                    e.Object.extend = function (t, n, r) {
                        ...
                        Object.defineProperty(i, "query", (0, a.default)(e.Object, "query")),
                        i.new = function (e, t) {
                            return new i(e, t)
                        },
                        ...
                        return o.then((function () {
                                return y((function () {
                                        ...
                                        if (e._arrayEach(d, (function (e) {
                                            ...
                                            return u.default.reject(new c(c.OTHER_CAUSE, "Tried to save a batch with a cycle."));
                ...
                e.exports = function (e) {
                    e.User = e.Object.extend("_User", {
                        ...
                        _handleSaveResult: function (t) {
                            ...
                            this._refreshCache(),
                            !t && !this.isCurrent() || e._config.disableCurrentUser ? o.default.resolve() : o.default.resolve(e.User._saveCurrentUser(this))
                        },
                        _linkWith: function (t, n) {
                            ...
                            u = o.failOnNotExist,
                            l = void 0 !== u && u;
                            return s.isString(t) ? (r = t, t = e.User._authProviders[t]) : r = t.getAuthType(),
                            n ? this.save({
                        ...
                        save: function (t, n, r) {
                            var i,
                            a;
                            return s.isObject(t) || s.isNull(t) || s.isUndefined(t) ? (i = t, a = n) : ((i = {})[t] = n, a = r),
                            a = a || {},
                        ...
                        current: function () {
                            if (e._config.disableCurrentUser)
                                return console.warn("AV.User.current() was disabled in multi-user environment, access user from request instead https://leancloud.cn/docs/leanengine-node-sdk-upgrade-1.html"), null;
                        ...
                        _saveCurrentUser: function (t) {
                            return (e.User._currentUser !== t ? e.User.logOut() : o.default.resolve()).then((function () {
                                    ...
                                    e.localStorage.setItemAsync(e._getAVPath(e.User._CURRENT_USER_KEY), (0, i.default)(n)).then((function () {
                ...
                e.exports = function (e) {
                    ...
                    e.Query.doCloudQuery = function (t, n, r) {
                        ...
                        return o.isArray(n) ? i.pvalues = n : r = n,
                    ...
                    o.extend(e.Query.prototype, {
                        ...
                        get: function (e, t) {
                            ...
                            if ("" === e)
                                return a.default.reject(new u(u.OBJECT_NOT_FOUND, "Object not found."));
                            ...
                            c("classes", this.className, e, "GET", f(i), t).then((function (e) {
                                    if (o.isEmpty(e))
                        ...
                        scan: function () {
                            ...
                            u = this._getParams();
                            s("scan %O", u),
                            u.order && (console.warn("The order of the query is ignored for Query#scan. Checkout the orderedBy option of Query#scan."), delete u.order),
                            u.skip && (console.warn("The skip option of the query is ignored for Query#scan."), delete u.skip),
                            u.limit && (console.warn("The limit option of the query is ignored for Query#scan."), delete u.limit),
                            n && (u.scan_key = n),
                            r && (u.limit = r);
                        ...
                        skip: function (e) {
                            return g(e, "undefined is not a valid skip value"),
                            this._skip = e,
                            this
                        },
                        limit: function (e) {
                            return g(e, "undefined is not a valid limit value"),
                            this._limit = e,
                            this
                        },
                        equalTo: function (t, n) {
                            return g(t, "undefined is not a valid key"),
                            g(n, "undefined is not a valid value"),
                            this._where[t] = e._encode(n),
                            this
                        },
                        _addCondition: function (t, n, r) {
                            return g(t, "undefined is not a valid condition key"),
                        ...
                        ascending: function (e) {
                            return g(e, "undefined is not a valid key"),
                            this._order = e,
                            this
                        },
                ...
                a.prototype.emit = function (e, t, n, r, i, a) {
                    ...
                    if (c.fn) {
                        ...
                        p = c.length;
                        for (l = 0; l < p; l++)
                            switch (c[l].once && this.removeListener(e, c[l].fn, void 0, !0), h) {
                            case 1:
                ...
                a.prototype.on = function (e, t, n) {
                    ...
                    a = s ? s + e : e;
                    return this._events[a] ? this._events[a].fn ? this._events[a] = [this._events[a], r] : this._events[a].push(r) : (this._events[a] = r, this._eventsCount++),
                    this
                },
                ...
                a.prototype.removeListener = function (e, t, n, i) {
                    ...
                    if (!this._events[a])
                        return this;
                    if (!t)
                        return 0 == --this._eventsCount ? this._events = new r : delete this._events[a], this;
                    var o = this._events[a];
                    if (o.fn)
                        o.fn !== t || i && !o.once || n && o.context !== n || (0 == --this._eventsCount ? this._events = new r : delete this._events[a]);
                    else {
                        for (var u = 0, l = [], c = o.length; u < c; u++)
                            (o[u].fn !== t || i && !o[u].once || n && o[u].context !== n) && l.push(o[u]);
                ...
                e.exports = function (e) {
                    ...
                    e.Push.send = function (e, t) {
                        if (e.where && (e.where = e.where._getParams().where), e.where && e.cql)
                ...
                e.exports = function (e) {
                    ...
                    e.Status = function (e, t) {
                        ...
                        this.query = null,
                        e && "object" === (void 0 === e ? "undefined" : (0, a.default)(e)) ? this.data = e : (e && (this.data.image = e), t && (this.data.message = t)),
                        this
                    },
                    ...
                    e.Status.countUnreadStatuses = function (n) {
                        ...
                        if (o.isString(r) || (a = r), !u(a) && null == n && !e.User.current())
                    ...
                    e.Status.resetUnreadCount = function (n) {
                        ...
                        return i.default.resolve(n || t(a)).then((function (t) {
                                ...
                                return n.inboxType = e._encode(r),
                                n.owner = e._encode(t),
                                s("subscribe/statuses/resetUnreadCount", null, null, "POST", n, a)
                            }))
                    },
                ...
                function u(e) {
                    for (var t, n, r = {}, i = e.split("&"), a = 0, o = i.length; a < o; ++a)
                         - 1 === (n = (t = i[a]).indexOf("=")) ? r[decodeURIComponent(t)] = "" : r[decodeURIComponent(t.slice(0, n))] = decodeURIComponent(t.slice(n + 1));
                    return r
                }
                function l(e) {
                ...
                function c(e) {
                    ...
                    this.headers = function (e) {
                        for (var t, n, r, i, a = e.split(/\r?\n/), o = {}, s = 0, u = a.length; s < u; ++s)
                             - 1 !== (t = (n = a[s]).indexOf(":")) && (r = n.slice(0, t).toLowerCase(), i = A(n.slice(t + 1)), o[r] = i);
                        return o
                    }
                ...
                h.prototype._end = function () {
                    ...
                    var r = function (t, n) {
                        n.total > 0 && (n.percent = n.loaded / n.total * 100, 100 === n.percent && clearTimeout(e._uploadTimeoutTimer)),
                        n.direction = t,
                        e.emit("progress", n)
                    };
                    ...
                    for (var o in this.header)
                        null !== this.header[o] && Object.prototype.hasOwnProperty.call(this.header, o) && t.setRequestHeader(o, this.header[o]);
                    ...
                    if (e)
                        return function (e) {
                            for (var t in a.prototype)
                                Object.prototype.hasOwnProperty.call(a.prototype, t) && (e[t] = a.prototype[t]);
                            return e
                        }
                    (e)
                }
                ...
                a.prototype.abort = function () {
                    return this._aborted || (this._aborted = !0, this.xhr && this.xhr.abort(), this.req && this.req.abort(), this.clearTimeout(), this.emit("abort")),
                    this
                },
                ...
                a.prototype.send = function (e) {
                    ...
                    if (t && c(this._data))
                        ...
                        "string" == typeof e ? (n || this.type("form"), n = this._header["content-type"], this._data = "application/x-www-form-urlencoded" === n ? this._data ? "".concat(this._data, "&").concat(e) : e : (this._data || "") + e) : this._data = e;
                ...
                function i(e) {
                    ...
                    (e) || function (e) {
                        if ((0, s.default)(Object(e)) || "[object Arguments]" === Object.prototype.toString.call(e))
...
a.prototype = {
    ...
    judgeBrowser: function () {
        ...
        if (/AppleWebKit\/(\S+)/.test(t)) {
            if (this.engine.name = "WebKit", this.engine.version = RegExp.$1, /OPR\/(\S+)/.test(t))
            ...
            e.opera ? (this.engine.name = "Presto", this.browser.name = "Opera", this.engine.version = this.browser.version = e.opera.version()) : /Opera[\/\s](\S+)/.test(t) ? (this.engine.name = "Presto", this.browser.name = "Opera", this.engine.version = browser.version = RegExp.$1) : /KHTML\/(\S+)/.test(t) ? (this.browser.name = "Konqueror", this.engine.name = "KHTML", this.engine.version = browser.version = RegExp.$1) : /Konqueror\/([^;]+)/.test(t) ? (this.browser.name = "Konqueror", this.engine.name = "Konqueror", this.engine.version = browser.version = RegExp.$1) : /rv:([^\)]+)\) Gecko\/\d{8}/.test(t) ? (this.engine.name = "Gecko", this.engine.version = RegExp.$1, /Firefox\/(\S+)/.test(t) && (this.browser.name = "Firefox", this.browser.version = RegExp.$1)) : /Trident\/([\d\.]+)/.test(t) ? (this.engine.name = "Trident", this.engine.version = RegExp.$1, (/rv\:([\d\.]+)/.test(t) || /MSIE ([^;]+)/.test(t)) && (this.browser.name = "IE", this.browser.version = RegExp.$1)) : /MSIE ([^;]+)/.test(t) && (this.engine.name = "Trident", this.engine.version = this.browser.version - 4, this.browser.name = "IE", this.browser.version = RegExp.$1)
    },
    judgeSystem: function () {
        ...
        this.system.name = t.indexOf("Linux") > -1 ? "Linux" : t.indexOf("SunOS") > -1 ? "Solaris" : t.indexOf("FreeBSD") > -1 ? "FreeBSD" : t.indexOf("X11") > -1 ? "X11" : this.system.name,
        "Windows" == this.system.name && /Win(?:dows )?([^do]{2})\s?(\d+\.\d+)?/.test(e) && ("NT" == RegExp.$1 ? this.system.version = {
                "5.0": "2000",
                5.1: "XP",
                "6.0": "Vista",
                6.1: "7",
...
(window, document), function (e) {
    ...
    function p(e, t) {
        return function (e, t) {
            ...
            a = [],
            o = [];
            for (a[15] = o[15] = void 0, 16 < i.length && (i = s(i, 8 * e.length)), n = 0; n < 16; n += 1)
                a[n] = 909522486 ^ i[n], o[n] = 1549556828 ^ i[n];
            return r = s(a.concat(l(t)), 512 + 8 * t.length),
            u(s(o.concat(r), 640))
        }
        (h(e), h(t))
    }
...
function () {
    ...
    function t(e, t) {
        ...
        for (var a = 0; a < e.length; ++a) {
            ...
            s = e[a];
            if ("object" != typeof s)
                return i.valid = !1, i.error = o + "must be an object, but " + typeof s + " given", i;
            if (!r.helper.isString(s.type))
                return i.valid = !1, i.error = o + 'property "type" must be a string, but ' + typeof s.type + " given", i;
            var u = s.type = s.type.toLowerCase();
            if ("language" === u && (u = s.type = "lang"), "html" === u && (u = s.type = "output"), "lang" !== u && "output" !== u && "listener" !== u)
                return i.valid = !1, i.error = o + "type " + u + ' is not recognized. Valid values: "lang/language", "output/html" or "listener"', i;
            if ("listener" === u) {
                if (r.helper.isUndefined(s.listeners))
                    return i.valid = !1, i.error = o + '. Extensions of type "listener" must have a property called "listeners"', i
            } else if (r.helper.isUndefined(s.filter) && r.helper.isUndefined(s.regex))
                return i.valid = !1, i.error = o + u + ' extensions must define either a "regex" property or a "filter" method', i;
            if (s.listeners) {
                if ("object" != typeof s.listeners)
                    return i.valid = !1, i.error = o + '"listeners" property must be an object but ' + typeof s.listeners + " given", i;
                for (var l in s.listeners)
                    if (s.listeners.hasOwnProperty(l) && "function" != typeof s.listeners[l])
                        return i.valid = !1, i.error = o + '"listeners" property must be an hash of [event name]: [callback]. listeners.' + l + " must be a function but " + typeof s.listeners[l] + " given", i
            }
            if (s.filter) {
                if ("function" != typeof s.filter)
                    return i.valid = !1, i.error = o + '"filter" must be a function, but ' + typeof s.filter + " given", i
            } else if (s.regex) {
                if (r.helper.isString(s.regex) && (s.regex = new RegExp(s.regex, "g")), !(s.regex instanceof RegExp))
                    return i.valid = !1, i.error = o + '"regex" property must either be a string or a RegExp object, but ' + typeof s.regex + " given", i;
                if (r.helper.isUndefined(s.replace))
                    return i.valid = !1, i.error = o + '"regex" extensions must implement a replace string or function', i
            }
        }
        return i
    }
    ...
    r.helper.matchRecursiveRegExp = function (e, t, n, r) {
        ...
        for (var i = l(e, t, n, r), a = [], o = 0; o < i.length; ++o)
            a.push([e.slice(i[o].wholeMatch.start, i[o].wholeMatch.end), e.slice(i[o].match.start, i[o].match.end), e.slice(i[o].left.start, i[o].left.end), e.slice(i[o].right.start, i[o].right.end)]);
        return a
    },
    r.helper.replaceRecursiveRegExp = function (e, t, n, i, a) {
        ...
        if (c > 0) {
            ...
            for (var d = 0; d < c; ++d)
                h.push(t(e.slice(s[d].wholeMatch.start, s[d].wholeMatch.end), e.slice(s[d].match.start, s[d].match.end), e.slice(s[d].left.start, s[d].left.end), e.slice(s[d].right.start, s[d].right.end))), d < c - 1 && h.push(e.slice(s[d].wholeMatch.end, s[d + 1].wholeMatch.start));
            s[c - 1].wholeMatch.end < e.length && h.push(e.slice(s[c - 1].wholeMatch.end)),
            u = h.join("")
        }
        return u
    },
    ...
    r.helper.padEnd = function (e, t, n) {
        ...
        return t >>= 0,
        n = String(n || " "),
        e.length > t ? String(e) : ((t -= e.length) > n.length && (n += n.repeat(t / n.length)), String(e) + n.slice(0, t))
    },
    ...
    r.Converter = function (e) {
        ...
        function n(e, n) {
            if (n = n || null, r.helper.isString(e)) {
                if (n = e = r.helper.stdExtName(e), r.extensions[e])
                    return console.warn("DEPRECATION WARNING: " + e + " is an old extension that uses a deprecated loading method.Please inform the developer that the extension should be updated!"), void function (e, n) {
        ...
        this.makeHtml = function (e) {
            ...
            l.smartIndentationFix && (e = function (e) {
                ...
                (e)),
            e = "\n\n" + e + "\n\n",
            e = (e = r.subParser("detab")(e, l, t)).replace(/^[ \t]+$/gm, ""),
            ...
            e = (e = (e = r.subParser("unescapeSpecialChars")(e, l, t)).replace(/¨D/g, "$$")).replace(/¨T/g, "¨"),
                ...
                preList: function (e) {
                    for (var t = e.querySelectorAll("pre"), n = [], i = 0; i < t.length; ++i)
                        if (1 === t[i].childElementCount && "code" === t[i].firstChild.tagName.toLowerCase()) {
                            ...
                            n.push(a),
                            t[i].outerHTML = '<precode language="' + o + '" precodenum="' + i.toString() + '"></precode>'
                        } else
                            n.push(t[i].innerHTML), t[i].innerHTML = "", t[i].setAttribute("prenum", i.toString());
                    return n
                }
                (n)
            };
    ...
    r.subParser("anchors", (function (e, t, n) {
            ...
            var i = function (e, i, a, o, s, u, l) {
                if (r.helper.isUndefined(l) && (l = ""), a = a.toLowerCase(), e.search(/\(<?\s*>? ?(['"].*['"])?\)$/m) > -1)
                    o = "";
                else if (!o) {
                    if (a || (a = i.toLowerCase().replace(/ ?\n/g, " ")), o = "#" + a, r.helper.isUndefined(n.gUrls[a]))
                        return e;
                    o = n.gUrls[a],
                ...
                return "" !== l && null !== l && (c += ' title="' + (l = (l = l.replace(/"/g, "&quot;")).replace(r.helper.regexes.asteriskDashAndColon, r.helper.escapeCharactersCallback)) + '"'),
                t.openLinksInNewWindow && !/^#/.test(o) && (c += ' rel="noopener noreferrer" target="¨E95Eblank"'),
                c + ">" + i + "</a>"
            };
            return e = (e = (e = (e = (e = n.converter._dispatch("anchors.before", e, t, n)).replace(/\[((?:\[[^\]]*]|[^\[\]])*)] ?(?:\n *)?\[(.*?)]()()()()/g, i)).replace(/\[((?:\[[^\]]*]|[^\[\]])*)]()[ \t]*\([ \t]?<([^>]*)>(?:[ \t]*((["'])([^"]*?)\5))?[ \t]?\)/g, i)).replace(/\[((?:\[[^\]]*]|[^\[\]])*)]()[ \t]*\([ \t]?<?([\S]+?(?:\([\S]*?\)[\S]*?)?)>?(?:[ \t]*((["'])([^"]*?)\5))?[ \t]?\)/g, i)).replace(/\[([^\[\]]+)]()()()()()/g, i),
            t.ghMentions && (e = e.replace(/(^|\s)(\\)?(@([a-z\d]+(?:[a-z\d.-]+?[a-z\d]+)*))/gim, (function (e, n, i, a, o) {
                            if ("\\" === i)
                                return n + a;
    ...
    m = function (e) {
        ...
        return function (t, n, i, a, o, s, u) {
            ...
            e.openLinksInNewWindow && (h = ' rel="noopener noreferrer" target="¨E95Eblank"'),
    ...
    g = function (e, t) {
        ...
        return function (n, i, a) {
            ...
            e.encodeEmails ? (o = r.helper.encodeEmailAddress(o + a), a = r.helper.encodeEmailAddress(a)) : o += a,
            i + '<a href="' + o + '">' + a + "</a>"
        }
    };
    r.subParser("autoLinks", (function (e, t, n) {
            "use strict";
            return e = (e = (e = n.converter._dispatch("autoLinks.before", e, t, n)).replace(d, m(t))).replace(f, g(t, n)),
    ...
    r.subParser("codeBlocks", (function (e, t, n) {
            ...
            e = (e += "¨0").replace(/(?:\n\n|^)((?:(?:[ ]{4}|\t).*\n+)+)(\n*[ ]{0,3}[^ \t\n]|(?=¨0))/g, (function (e, i, a) {
                    ...
                    s = a,
                    u = "\n";
                    return o = r.subParser("outdent")(o, t, n),
    ...
    r.subParser("codeSpans", (function (e, t, n) {
            ...
            e = e.replace(/(^|[^\\])(`+)([^\r]*?[^`])\2(?!`)/gm, (function (e, i, a, o) {
                        var s = o;
    ...
    r.subParser("githubCodeBlocks", (function (e, t, n) {
            ...
            return t.ghCodeBlocks ? (e = n.converter._dispatch("githubCodeBlocks.before", e, t, n), e = (e += "¨0").replace(/(?:^|\n)(?: {0,3})(```+|~~~+)(?: *)([^\s`~]*)\n([\s\S]*?)\n(?: {0,3})\1/g, (function (e, i, a, o) {
                        ...
                        return o = r.subParser("encodeCode")(o, t, n),
                        o = "<pre><code" + (a ? ' class="' + a + " language-" + a + '"' : "") + ">" + (o = (o = (o = r.subParser("detab")(o, t, n)).replace(/^\n+/g, "")).replace(/\n+$/g, "")) + s + "</code></pre>",
    ...
    r.subParser("hashCodeTags", (function (e, t, n) {
            ...
            e = r.helper.replaceRecursiveRegExp(e, (function (e, i, a, o) {
    ...
    r.subParser("headers", (function (e, t, n) {
            ...
            function i(e) {
                ...
                return i = e,
                a = r.helper.isString(t.prefixHeaderId) ? t.prefixHeaderId : !0 === t.prefixHeaderId ? "section-" : "",
    ...
    r.subParser("images", (function (e, t, n) {
            ...
            function i(e, t, i, a, o, s, u, l) {
                ...
                h = n.gTitles,
                d = n.gDimensions;
                if (i = i.toLowerCase(), l || (l = ""), e.search(/\(<?\s*>? ?(['"].*['"])?\)$/m) > -1)
                    a = "";
                else if ("" === a || null === a) {
                    if ("" !== i && null !== i || (i = t.toLowerCase().replace(/ ?\n/g, " ")), a = "#" + i, r.helper.isUndefined(c[i]))
                        return e;
                    a = c[i],
                    r.helper.isUndefined(h[i]) || (l = h[i]),
                    r.helper.isUndefined(d[i]) || (o = d[i].width, s = d[i].height)
                }
                ...
                return l && r.helper.isString(l) && (p += ' title="' + (l = l.replace(/"/g, "&quot;").replace(r.helper.regexes.asteriskDashAndColon, r.helper.escapeCharactersCallback)) + '"'),
                o && s && (p += ' width="' + (o = "*" === o ? "auto" : o) + '"', p += ' height="' + (s = "*" === s ? "auto" : s) + '"'),
                p + " />"
            }
            ...
            e = (e = (e = e.replace(/!\[([^\]]*?)][ \t]*()\([ \t]?<([^>]*)>(?: =([*\d]+[A-Za-z%]{0,4})x([*\d]+[A-Za-z%]{0,4}))?[ \t]*(?:(?:(["'])([^"]*?)\6))?[ \t]?\)/g, i)).replace(/!\[([^\]]*?)][ \t]*()\([ \t]?<?([\S]+?(?:\([\S]*?\)[\S]*?)?)>?(?: =([*\d]+[A-Za-z%]{0,4})x([*\d]+[A-Za-z%]{0,4}))?[ \t]*(?:(["'])([^"]*?)\6)?[ \t]?\)/g, i)).replace(/!\[([^\[\]]+)]()()()()()/g, i),
    ...
    r.subParser("lists", (function (e, t, n) {
            ...
            e += "¨0",
            e = n.gListLevel ? e.replace(/^(( {0,3}([*+-]|\d+[.])[ \t]+)[^\r]+?(¨0|\n{2,}(?=\S)(?![ \t]*(?:[*+-]|\d+[.])[ \t]+)))/gm, (function (e, t, n) {
    ...
    r.subParser("paragraphs", (function (e, t, n) {
            ...
            for (o = a.length, s = 0; s < o; s++) {
                for (var l = "", c = a[s], h = !1; /¨(K|G)(\d+)\1/.test(c); ) {
                    var d = RegExp.$1,
                    p = RegExp.$2;
                    l = (l = "K" === d ? n.gHtmlBlocks[p] : h ? r.subParser("encodeCode")(n.ghCodeBlocks[p].text, t, n) : n.ghCodeBlocks[p].codeblock).replace(/\$/g, "$$$$"),
                    c = c.replace(/(\n\n)?¨(K|G)\d+\2(\n\n)?/, l),
    ...
    r.subParser("stripLinkDefinitions", (function (e, t, n) {
            ...
            var i = function (e, i, a, o, s, u, l) {
                ...
                a.match(/^data:.+?\/.+?;base64,/) ? n.gUrls[i] = a.replace(/\s/g, "") : n.gUrls[i] = r.subParser("encodeAmpsAndAngles")(a, t, n),
                u ? u + l : (l && (n.gTitles[i] = l.replace(/"|'/g, "&quot;")), t.parseImgDimensions && o && s && (n.gDimensions[i] = {
                            width: o,
                            height: s
                        }), "")
            };
    ...
    r.subParser("tables", (function (e, t, n) {
            ...
            function a(e, i) {
                ...
                "<th" + a + i + ">" + (e = r.subParser("spanGamut")(e, t, n)) + "</th>\n"
            }
            function o(e, i) {
            ...
            function s(e) {
                ...
                for (u.shift(), u.shift(), s = 0; s < u.length; ++s)
                    "" !== u[s].trim() && h.push(u[s].split("|").map((function (e) {
                                return e.trim()
                            })));
    ...
    r.subParser("makeMarkdown.image", (function (e) {
            "use strict";
            var t = "";
            return e.hasAttribute("src") && (t += "![" + e.getAttribute("alt") + "](", t += "<" + e.getAttribute("src") + ">", e.hasAttribute("width") && e.hasAttribute("height") && (t += " =" + e.getAttribute("width") + "x" + e.getAttribute("height")), e.hasAttribute("title") && (t += ' "' + e.getAttribute("title") + '"'), t += ")"),
            t
        })),
    ...
    r.subParser("makeMarkdown.list", (function (e, t, n) {
            ...
            if (!e.hasChildNodes())
                return "";
            for (var a = e.childNodes, o = a.length, s = e.getAttribute("start") || 1, u = 0; u < o; ++u)
                void 0 !== a[u].tagName && "li" === a[u].tagName.toLowerCase() && (i += ("ol" === n ? s.toString() + ". " : "- ") + r.subParser("makeMarkdown.listItem")(a[u], t), ++s);
            return (i += "\n\x3c!-- --\x3e\n").trim()
        })),
    ...
    r.subParser("makeMarkdown.table", (function (e, t) {
            ...
            for (n = 0; n < u.length; ++n) {
                ...
                for (i = 0; i < s.length; ++i) {
                    var p = " ";
                    void 0 !== d[i] && (p = r.subParser("makeMarkdown.tableCell")(d[i], t)),
                    o[h].push(p)
                }
            }
            var f = 3;
            ...
            for (n = 0; n < o.length; ++n) {
                for (i = 0; i < o[n].length; ++i)
                    1 === n ? ":" === o[n][i].slice(-1) ? o[n][i] = r.helper.padEnd(o[n][i].slice(-1), f - 1, "-") + ":" : o[n][i] = r.helper.padEnd(o[n][i], f, "-") : o[n][i] = r.helper.padEnd(o[n][i], f);
                a += "| " + o[n].join(" | ") + " |\n"
            }
            return a.trim()
        })),
...
atEvery.prototype.init = function (e) {
    ...
    if (t.config = e, console.log(window.AV), window.AV)
        ...
        (window.ActiveXObject || "ActiveXObject" in window) && n.readyState ? n.onreadystatechange = function () {
    ...
    case "en":
        ...
        B = "Request has been terminated Possible causes: the network is offline, Origin is not allowed by Access-Control-Allow-Origin, the page is being unloaded, etc.c",
        R = "Could not find user.",
        D = "You have entered incorrect passwords for too many times. Please try later or reset your password.";
        break;
    case "es":
        y = "Carga más...",
        b = "Avance",
        ...
        B = "La solicitud ha sido cancelada Posibles causas: la red está fuera de línea, Access-Control-Allow-Origin no permite Origin, la página se está descargando, etc.c",
        R = "No se pudo encontrar el usuario.",
        D = "Ha introducido contraseñas incorrectas demasiadas veces. Inténtelo más tarde o restablezca su contraseña."
    }
    let F = "";
    for (let e in a)
        F = F + "<img alt='[" + e + "]' title='" + e + "' onclick='insertEmoji(\"[" + e + "]\")' class='atemoji gallery-group-img' src='" + a[e] + "'/>";
    l = void 0 === l ? "" : l,
    c = void 0 === c ? "" : c,
    ...
    ne.onclick = function () {
        ...
        V("shade"),
        e ? (V("userinfo"), document.getElementById("status").innerHTML = k + ":\t" + e.attributes.username, V("tui")) : (V("tui"), V("shuoshuo-modal"), Q())
    },
    re.onclick = function () {
        $()
    },
    ie.onclick = function () {
        ...
        if (document.getElementById("logw").style.color = "black", document.getElementById("logw").innerHTML = "loading...", "" === t)
            return document.getElementById("logw").style.color = "red", void(document.getElementById("logw").innerHTML = N);
        let n = document.getElementById("username").value;
        if ("" === n)
            return document.getElementById("logw").style.color = "red", void(document.getElementById("logw").innerHTML = L);
        AV.User.logIn(n, t).then((t => {
                ...
                -1 != t.indexOf("mismatch") ? t = U : -1 != t.indexOf("terminated") ? t = B : -1 != t.indexOf("Could not find user.") ? t = R : -1 != t.indexOf("Please try later or reset your password.") && (t = D),
    ...
    oe.onclick = function () {
        ...
        "none" === document.getElementById("shuoshuo_emojiswitch").style.display ? (V("shuoshuo_emoji_Tieba"), V("shuoshuo_emojiswitch"), document.getElementById("shuoshuo_emoji_BiliBili").innerHTML = atEmojiB, document.getElementById("shuoshuo_emoji_Tieba").innerHTML = atEmojiT, document.getElementById("shuoshuo_emoji_QQ").innerHTML = atEmojiQ, document.getElementById("shuoshuo_emoji_custom").innerHTML = F, document.getElementById("shuoshuo_emojiswitch").classList.add("pingjun")) : (W("shuoshuo_emoji_Tieba"), W("shuoshuo_emoji_BiliBili"), W("shuoshuo_emoji_custom"), W("shuoshuo_emoji_QQ"), W("shuoshuo_emojiswitch"), document.getElementById("shuoshuo_emojiswitch").classList.remove("pingjun"))
    },
    se.onclick = function () {
    ...
    me.onclick = function () {
        if (!AV.User.current())
            return document.getElementById("logw").innerHTML = "<center><pre><code>" + T + "</code></pre></center>", V("shade"), void V("shuoshuo-modal");
    ...
    atEvery.prototype.delete = function (e) {
        ...
        n("shade"),
        n("shanchur"),
        document.getElementById("delete1").innerHTML = '<input type="button" class="at_button" value="' + j + '" id="Delete"><input type="button" class="at_button" value="' + O + '" id="cancelDelete">';
    ...
    if (!/\.(jpg|gif|jpeg|ico|png|svg|mp4|mov)$/.test(file.name))
        return void alert("不支持的文件类型，支持的文件格式有jpg|gif|jpeg|ico|png|svg|mp4|mov");
    let fileType = "",
    ...
    /\.(jpg|gif|jpeg|ico|png|svg)$/.test(file.name) ? fileType = "image" : /\.(mp4|mov)$/.test(file.name) && (fileType = "video"),
    fadeIn("lazy");
    ...
    xhr.addEventListener("readystatechange", (function () {
            if (4 === this.readyState && 200 === this.status) {
                ...
                sourceMd = "";
                "video" === fileType ? sourceMd = '<video controls width="100%" height="auto"><source src="' + sourceUrl.data.url + '"></video>' : "image" === fileType && (sourceMd = "![](" + sourceUrl.data.url + ")"),
                insertEmoji(sourceMd),
                document.getElementById("pubShuo").click(),
                fadeOut("lazy")
            } else
                4 === this.readyState && 500 === this.status && fadeOut("lazy")
        })),
    xhr.open("POST", "https://7bu.top/api/upload");
    let imgToken = AV.User.current().attributes.imgToken;
    void 0 !== imgToken && (xhr.setRequestHeader("Authorization", "Basic VGVzdDoxMjM0NTY="), xhr.setRequestHeader("token", imgToken)),
    xhr.send(data)
    ...
    case "es":
        ...
        p = "Por favor, introduzca las modificaciones en el cuadro de abajo y haga clic en guardar",
        f = "guardar",
        m = "comentarios",
        g = "Buzón",
        _ = "Apodo"
    ...
    y.find().then((function (t) {
            ...
            ("lazy"),
            0 !== b ? v("readmore") : 0 !== e && (document.getElementById("readButton").innerHTML = "<center>已经到底了哦~</center>", document.getElementById("readButton").style.opacity = "0.5")
        })),
